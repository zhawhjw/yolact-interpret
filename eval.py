...
def parse_args(argv=None):
    ...
    parser.add_argument('--display_bboxes', default=True
, type=str2bool,
...
def evalimage(net:Yolact, path:str, save_path:str=None):
    ...
    pname = save_path.split(".")[0]


    torch.save(activation['proto'], pname+'.pt')
    print(pname+".pt")
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        proto = (net.proto_net)[0]
        print(type(proto))
        proto.register_forward_hook(get_activation('proto'))
